        ...
        <div className='border-white rounded-xl border-[3px] bg-transparent shadow-lg shadow-white'>
          ...
          <div className='flex md:flex-row flex-col'>
            ...
            <div className="md:w-1/2 p-20">
              <h2 className="text-3xl font-bold mb-6 text-center text-white uppercase font-Montserrat">Sign Up</h2>
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <label htmlFor="name" className="block text-sm font-medium text-white">Name</label>
                  <input type="text" id="name" name="name" value={formData.name} onChange={handleChange} className="mt-1 p-2 w-full border-[3px] border-accent bg-transparent rounded-md" />
                </div>
                <div>
                ...
                <div>
                  ...
                  <textarea id="bio" name="bio" value={formData.bio} onChange={handleChange} className="mt-1 p-2 w-full border-[3px] border-accent bg-transparent rounded-md"></textarea>
                </div>
                
                <button
            type="submit"
            className="bg-transperant text-white p-2 rounded-md w-full border-white border-[3px]"
          >
            Sign Up
          </button>
